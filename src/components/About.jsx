...
function About(){
    ...
    return(
        ...
        <div className="pr-5 pl-5 mb-16" ref={element}>
        {screen && 
            <>
                ...
                <div className="flex w-full flex-col text-start mb-9 rounded-xl animate-wiggle">
                    <p className="text-black mb-3 text-xl font-extrabold leading-8"><b className="text-[#00f0ff]">Hi, i am Matias Seitour </b>Frontend developer focused on web page design, creation of clear codes and with the ability to meet the objectives and needs of customers.<br></br><br></br>I am looking for a position as a developer that allows me to demonstrate my skills and express my creativity in the company</p>
                </div>
                <div className="mt-10 w-full h-full flex items-center flex-col">
                    <a href="../public/cv.pdf" download className="btn text-white bg-black w-2/6 p-2 border-2 border-[#00f0ff]">{` `} Descargar cv</a>
                </div>
            </>
        }
    </div>
